 ...
 * A setter function is called when a value is assigned to object with same variable name.
 *
 * We use `get` keywork to define a `getter` function.
...
class Person {
  ...
  //  _ (underscore) prefix makes variable private to the library
