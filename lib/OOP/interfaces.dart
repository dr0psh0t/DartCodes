 ...
 *
 * In Dart, a class is also defined as interface implicitly. Hence they are called implicit interfaces.
 ...
 *
 * TIPS:
 * 1. If a sub-class `extends` an `abstract` super-clss with methods lacking body signature,
...
abstract class Person {
  ...
  //  constructor is not a poart of the `Person` interface
...
class Employee implements Person {
  ...
  //  ENFORCED: instance variables delaration from the `Person` interface
  String firstName, lastName;
