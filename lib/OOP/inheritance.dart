 ...
 * A class that is inheriting another class is called sub-class while the class that it inherits from is called `super-class`.
 *
 ...
 *
 * When a `super-class` constructor function or method is called form the `sub-class`,
